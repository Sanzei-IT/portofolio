      ...
      >
        <div className="text-center relative">
          ...
          <div className="flex justify-center space-x-4 mb-8">
            <a 
              href="mailto:sanzeisoft@gmail.com" 
          ...
          <div className="space-y-6">
            <div className="flex items-center space-x-4 transform hover:translate-x-2 transition-transform">
              ...
              <div>
                ...
                <a href="mailto:sanzeisoft@gmail.com" className="text-purple-500 hover:text-purple-600">
                  sanzeisoft@gmail.com
                </a>
              </div>
            </div>
            <div className="flex items-center space-x-4 transform hover:translate-x-2 transition-transform">
      ...
      <footer className={`${darkMode ? 'bg-gray-800/50' : 'bg-white'} py-8 mt-16`}>
        <div className="container mx-auto px-4 text-center">
          <p className={`${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>
            © 2025 SanzeiSoft Developer. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
